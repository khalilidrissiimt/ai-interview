...
export default function Home() {
  ...
  const handleStart = () => {
    ...
    }, 600); // short delay for spinner effect
  };
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full">
      <div className="relative z-10 flex flex-col items-center w-full">
        ...
        <Image src="/robot.png" alt="AI Interview Robot" width={250} height={250} className="mb-6 mt-2" />
        <h1 className="text-3xl font-bold mb-4 text-center">AI-Powered Interview Practice</h1>
        <p className="text-lg mb-6 text-center max-w-xl">
          Want Interview Questions That Actually Match Your Resume?
        </p>
        {loading && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
            <div className="bg-zinc-900 rounded-2xl p-8 flex flex-col items-center gap-4 min-w-[320px] relative shadow-xl">
              ...
              <span className="text-lg font-medium text-white">Redirecting to resume upload...</span>
            </div>
          </div>
        )}
        <button
